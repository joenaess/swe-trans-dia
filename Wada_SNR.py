...
def wada_snr(audio_path):
    ...
    # Check if stereo and merge to mono
    if waveform.shape[0] == 2:
        waveform = torchaudio.functional.stereo_to_mono(waveform)  # Use torchaudio for channel merging
